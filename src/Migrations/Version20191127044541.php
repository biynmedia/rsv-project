 ...
 */
final class Version20191127044541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT AUTO_INCREMENT NOT NULL, topic_id INT NOT NULL, user_id INT NOT NULL, summary VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, writing_date DATETIME NOT NULL, updated_date DATETIME NOT NULL, deleted_date DATETIME NOT NULL, publish_date DATETIME NOT NULL, revision_number INT NOT NULL, INDEX IDX_DADD4A251F55203D (topic_id), INDEX IDX_DADD4A25A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, topic_id INT NOT NULL, content VARCHAR(180) NOT NULL, writing_date DATETIME NOT NULL, type ENUM(\'public\', \'private\') NOT NULL COMMENT \'(DC2Type:enumcomment)\', INDEX IDX_9474526C1F55203D (topic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE topic (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, category_id INT NOT NULL, name VARCHAR(180) NOT NULL, summary VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, writing_date DATETIME NOT NULL, updated_date DATETIME DEFAULT NULL, deleted_date DATETIME DEFAULT NULL, publish_date DATETIME DEFAULT NULL, alias VARCHAR(180) NOT NULL, INDEX IDX_9D40DE1BA76ED395 (user_id), INDEX IDX_9D40DE1B12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
